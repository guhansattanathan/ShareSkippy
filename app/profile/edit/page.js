          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-4 sm:space-y-0 sm:space-x-6 mb-6">
            ...
            {profile.profile_photo_url ? (
              <Image
                ...
                width={128} // next/image requires width/height
                height={128} // next/image requires width/height
                  ...
                  <div className="flex items-center space-x-4">
                    {dog.photo_url ? (
                      <Image
                        src={dog.photo_url}
                        alt={dog.name}
                        width={64} // next/image requires width/height
                        height={64} // next/image requires width/height
